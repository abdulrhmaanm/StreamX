...
export const Navbar = () => {
  ...
  const searchInput = (
    <form onSubmit={handleSearch} className="w-full">
      <Input
        ...
        endContent={
          <Kbd
            className="hidden lg:inline-flex bg-white/5 border border-white/10 text-zinc-500 text-[10px] px-1.5"
            keys={["command"]}
          >
            K
          </Kbd>
        ...
        startContent={
          <SearchIcon className="text-zinc-500 pointer-events-none flex-shrink-0 text-base" />
        }
        type="search"
      />
    </form>
  ...
  return (
    ...
    >
      ...
      {/* ── Mobile menu ── */}
      <NavbarMenu
        className="bg-[#07070a]/95 backdrop-blur-xl border-t border-white/5 pt-6 pb-8 px-6 gap-4"
      >
        {/* Mobile search */}
        <div className="mb-2">
          {searchInput}
